function card(id, name, cost, description, effects, options = {}) {
  return { id, name, cost, description, effects, type: options.type, exhaust: options.exhaust };
}

export const cards = {
  foundingStone: card('foundingStone', 'Founding Stone', 1, 'Deal 6 damage.', [{ type: 'damage', amount: 6 }], { type: 'attack' }),
  ...
  encourage: card('encourage', 'Encourage', 0, 'Gain 1 energy. Draw 1 card.', [{ type: 'energy', amount: 1 }, { type: 'draw', amount: 1 }]),
  panic: { id: 'panic', name: 'Panic', cost: 0, description: 'Unplayable.', unplayable: true, effects: [] },
  ...
  readTheBeast: card('readTheBeast', 'Read the Beast', 0, 'Draw 1 card. Exhaust.', [{ type: 'draw', amount: 1 }], { exhaust: true }),
