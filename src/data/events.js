    ...
    choices: [
      {
        ...
        effects: {
          gainRandomResource: { pool: ['strangeEye', 'ichor'], amount: 1 },
          loseHp: 2,
          addInjury: 'deepCut'
        }
      },
    ...
    choices: [
      {
        ...
        effects: { loseHp: 1, addInjury: 'twistedAnkle' }
      },
      {
        id: 'stand',
        text: 'Stand firm',
    ...
    choices: [
      {
        ...
        effects: { healFull: true, addScar: 'deadEyeCalm' }
      },
      {
        id: 'collect',
        text: 'Collect',
    ...
    choices: [
      {
        ...
        effects: { pendingSpecialChildTrait: 'quietListener' }
      },
      {
        id: 'sleep',
        text: 'Let them sleep',
