...
export const creatureFamilies = {
  ...
  theKingInspired: family('theKingInspired', 'The King Inspired', 'quarry', false, false, 'A late campaign quarry.', ['royal', 'nemesis']),
  ...
  blackKnightInspired: family('blackKnightInspired', 'Black Knight Inspired', 'nemesis', false, false, 'Future content family.', ['knight']),
  redWitchesInspired: family('redWitchesInspired', 'Red Witches Inspired', 'nemesis', false, false, 'Future content family.', ['witch', 'blood']),
  childEaterInspired: family('childEaterInspired', 'Child Eater Inspired', 'nemesis', false, false, 'Future content family.', ['nemesis']),
  pariahInspired: family('pariahInspired', 'Pariah Inspired', 'nemesis', false, false, 'Future wanderer content.', ['wanderer']),
  watcherInspired: family('watcherInspired', 'Watcher Inspired', 'finale', false, false, 'Future content family.', ['watcher']),
  goldSmokeKnightInspired: family('goldSmokeKnightInspired', 'Gold Smoke Knight Inspired', 'finale', false, false, 'Future content family.', ['smoke', 'knight']),
  gamblerInspired: family('gamblerInspired', 'Gambler Inspired', 'finale', false, false, 'Future wanderer content.', ['chance']),
  godhandInspired: family('godhandInspired', 'Godhand Inspired', 'finale', false, false, 'Future content family.', ['boss']),
  wanderersPack: family('wanderersPack', 'Wanderers Pack', 'special', false, false, 'Future modular content.', ['wanderers']),
  scoutPack: family('scoutPack', 'Scout Pack', 'special', false, false, 'Future modular content.', ['scouting']),
  whiteBoxPack: family('whiteBoxPack', 'White Box Pack', 'special', false, false, 'Future modular content.', ['equipment']),
  strainPack: family('strainPack', 'Strain Pack', 'special', false, false, 'Future modular content.', ['strain']),
  philosophyPack: family('philosophyPack', 'Philosophy Pack', 'special', false, false, 'Future modular content.', ['philosophy'])
};
