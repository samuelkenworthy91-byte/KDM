...
const passives = {
  ...
  shield: ['First shield card each combat gives +2 block. Counters against claws and body gain +2 break.', 'If block remains after a monster turn, gain 1 survival once per combat.', 'Once per combat, a shield attack adds up to 8 block as damage.'],
